...
describe("render", () => {
    it("shows error if errors with [label] key passed", () => {
        ...
        const props = { register: jest.fn(), label, errors: {[label]: {message}} };
...
describe('pass props', () => {
    it("passes label, hasError and rest props to entity",  () => {
        ...
        const props = { register: jest.fn(), label, isPasswordField: true, errors: {[label]: {message: "some error message"}}, ...rest };
