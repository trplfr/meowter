...
describe("passes props", () => {
    ...
    it("passes helmet title and description", () => {
        ...
        expect(wrapper.find(HelmetComponent).props().children.find(c => c.type === 'title').props.children).toBe(helmetTitle);
        expect(wrapper.find(HelmetComponent).props().children.find(c => c.type === 'meta' && c.props.name === 'description').props.content).toBe(helmetDescription);
